...
public class Rotation implements android.os.Parcelable
  ...
  /* actually quaternion is (c, s * x, s * y, s * z) */
    ...
    public Rotation
      ...
      /* constructs a ug.karuhanga.planimeter.Rotation that rotates by the specified angle
        about the axis direction (X, Y, Z). */
      {
        ...
        y = Y / Mag;
        z = Z / Mag;
      } /*ug.karuhanga.planimeter.Rotation*/
    ...
    public String toString()
      {
        return
            String.format
              (
                GLUseful.StdLocale,
                "ug.karuhanga.planimeter.Rotation(%e, %e, %e, %e, %e)",
                c, s, x, y, z
              );
      } /*toString*/
