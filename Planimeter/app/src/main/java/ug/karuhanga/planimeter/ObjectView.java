...
import static ug.karuhanga.planimeter.Useful.GetTime;
...
public class ObjectView extends android.opengl.GLSurfaceView {
                                ...
                                public boolean onFling
                                    ...
                                    final float SpinDuration =
                                            (float) Math.hypot(XVelocity, YVelocity)
                                                    ...
                                                    /
                                                    FinalAttenuate;
                                    System.err.printf("ObjViewer.ug.karuhanga.planimeter.ObjectView: spin duration = %.3fs\n", SpinDuration); /* debug */
    ...
    } /*ug.karuhanga.planimeter.ObjectView*/
    ...
    private Rotation CalculateNewRotation
        ...
        { /* debug */
            ...
            System.err.printf("ObjViewer.ug.karuhanga.planimeter.ObjectView.CalculateNewRotation fling %s LastMouse(%.3f, %.3f) × ThisMouse(%.3f, %.3f) => rotation %.3f° about (%.3f, %.3f, 0)°\n", Fling, LastMouse.x, LastMouse.y, ThisMouse.x, ThisMouse.y, RotationAngle, (ThisMouse.y - MidPoint.y) / Radius, (ThisMouse.x - MidPoint.x) / Radius);
        } /* debug */
        return
