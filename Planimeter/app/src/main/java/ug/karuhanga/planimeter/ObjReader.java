...
public class ObjReader
            ...
            throw new DataFormatException
              (
                String.format
                  (
                    GLUseful.StdLocale,
                    "ug.karuhanga.planimeter.ObjReader error at line %d, col %d: %s",
                    LineNr, ColNr,
                    Msg
                  )
              );
            ...
            else if (Op != null)
              {
                if (Op == "v")
                ...
                else
                  {
                    System.err.printf
                      (
                        "ug.karuhanga.planimeter.ObjReader.ReadObj warning: ignoring op \"%s\" on line %d.\n",
                        Op,
                        Parse.LineNr
                      );
                    Parse.SkipRest();
            ...
            if (Op == null && Parse.EOF || Op == "newmtl")
              ...
              /* "illum" NYI */
                else
                  {
                    System.err.printf
                      (
                        "ug.karuhanga.planimeter.ObjReader.ReadMaterials warning: ignoring op \"%s\" on line %d.\n",
                        Op,
                        Parse.LineNr
                      );
                    Parse.SkipRest();
  ...
  } /*ug.karuhanga.planimeter.ObjReader*/
